...
plt.title('Média de Acurácia de Validação por Cliente - Medium', fontsize=16)
plt.xlabel('Cliente', fontsize=14)
plt.ylabel('Média de Acurácia de Validação', fontsize=14)
