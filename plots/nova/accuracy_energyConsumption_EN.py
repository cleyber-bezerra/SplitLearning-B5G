...
files = ['accuracy.csv', 'energyConsumption.csv']
colors = ['b', 'y']
labels = ['Accuracy', 'Energy Consumption']
...
plt.title('Change in Accuracy and Energy Consumption', fontsize=16)
...
name_output_file = "graphEnergyConsumption"
