...
files = ['accuracy.csv', 'lostPacketsVector.csv']
colors = ['b', 'r']
labels = ['Accuracy', 'Packet Loss']
...
plt.title('Accuracy Change and Packet Loss', fontsize=16)
...
name_output_file = "graphPacketLoss"
