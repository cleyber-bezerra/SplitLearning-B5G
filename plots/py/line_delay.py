...
# Calcular a média de Delay por usuário
mean_delay_per_user = data.groupby('User')['Delay'].mean()
...
plt.xlabel('Atrasos (s)', fontsize=14)
...
plt.savefig('../graph/graph_line_delay.png')
