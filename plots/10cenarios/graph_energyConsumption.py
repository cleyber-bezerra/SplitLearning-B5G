...
files = ['cenario_1_13/energyConsumption.csv', 'cenario_2_26/energyConsumption.csv']
colors = ['g', 'b']
...
#plt.title('Consumo Energético por cenário', fontsize=16)
plt.xlabel('Distância dos dispositivos até gNB (m)', fontsize=22)
plt.ylabel('Consumo Energético (J)', fontsize=22)
plt.grid(True)
...
name_output_file = "graficoEnergia"
