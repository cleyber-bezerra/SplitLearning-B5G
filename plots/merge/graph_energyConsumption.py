...
files = ['low/energyConsumption.csv', 'medium/energyConsumption.csv', 'high/energyConsumption.csv']
colors = ['g', 'b', 'r']
...
plt.title('Average Energy Consumption for each User', fontsize=16)
...
name_output_file = "EnergyConsumption"
