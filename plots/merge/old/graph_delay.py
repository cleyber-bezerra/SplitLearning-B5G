...
files = ['low/delay.csv', 'medium/delay.csv', 'high/delay.csv']
colors = ['g', 'b', 'r']
labels = ['TxPower = 0 dBM', 'TxPower = 10 dBM', 'TxPower = 20 dBM']
...
plt.title('Canal de baixa perda', fontsize=16)
