...
files = ['low/lostPacketsVector.csv', 'medium/lostPacketsVector.csv', 'high/lostPacketsVector.csv']
colors = ['g', 'b', 'r']
...
plt.title('Average Lost Packets for each User', fontsize=16)
plt.xlabel('Users', fontsize=15)
plt.ylabel('Lost Packets', fontsize=15)
plt.grid(True)
...
name_output_file = "lostPacketsVector"
