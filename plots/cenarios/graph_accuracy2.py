...
#plt.title('Acuracia por cenário', fontsize=16)
plt.xlabel('Distância dos dispositivos até gNB (m)', fontsize=22)
plt.ylabel('Acuracia (s)', fontsize=22)
plt.grid(True)
plt.legend(loc='lower left', bbox_to_anchor=(0.6, 0.1), fontsize=18)  # Legenda no canto inferior direito
