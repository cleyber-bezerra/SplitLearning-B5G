...
files = ['cenario_1_13/delay.csv', 'cenario_2_26/delay.csv']
colors = ['m', 'b']
...
#plt.title('Latência por cenário', fontsize=16)
plt.xlabel('Distância dos dispositivos até gNB (m)', fontsize=22)
plt.ylabel('Latência (s)', fontsize=22)
plt.grid(True)
plt.legend(loc='center right', bbox_to_anchor=(0.4, 0.9), fontsize=18)  # Legenda no canto inferior direito
...
name_output_file = "graficoAtrasos"
